...
<?php 
//Поиск товара не находящегося в базе
...
<li>Сортировать:</li>
<li><a id="select-sort">'.$sort_nam.'</a>
...
$query = "SELECT COUNT (*) FROM table_products WHERE title LIKE '%$search%' AND visible ='1'";
...
if (mysqli_num_rows($result) > 0)
{
	...
	while ($row =mysqli_fetch_array($result));	
	 ...
	 echo "<p>Поисковое значенние должно быть от 3 до 64 символов!</p>";	
	}
...
$db = mysqli_connect("192.168.1.34","lilia","password", "db_shop") or die ("Error");
#$db->query( "SET CHARSET utf8" );
$query = "SELECT * FROM table_products WHERE title LIKE '%$search%' AND visible ='1' ORDER BY $sorting ";
